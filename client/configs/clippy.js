...
//       if ((route === 'Document' || route === 'Template') &&
//         Session.get('structureState') === 'tree' &&
//         !Session.get('editChapterNodeName') &&
//         !Session.get('inlineEditNode') &&
//         (Session.get('nodeInFocus') &&
//         !(Session.get('nodeInFocus') === Session.get('mainDocument')))) {
//
//         $('div.tooltip').hide();
