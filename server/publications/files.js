...
export default function () {
  ...
  Meteor.publish('Files.byId', (_id) => Files.find({ _id }));

  Meteor.publish('Files.byNode', (id) => {
  ...
  Meteor.publish('Files.byDocument', (docId) => Files.find({ docId }));

  Meteor.publish('Files.byArtificialNode', (an) => {
